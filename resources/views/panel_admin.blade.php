...
@section('content')
    ...
    <main class="d-flex flex-wrap">
        ...
        <section id="add" class="container w-100 border border-1 border-dark my-5 py-5">
            ...
            <form enctype="multipart/form-data" action="/a/b/c/d/e/f/gosave" method="POST"
                ...
                <div class="mb-3" style="width: 47.5%">
                    ...
                    <textarea name="description" class="form-control" id="desc" rows="4"></textarea>
                    @error('description')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
        ...
        <section id="edit" class="container w-100 border border-1 border-dark my-5 py-5"></section>
        <section id="delete" class="container w-100 border border-1 border-dark my-5 py-5"></section>
    </main>
@endsection
@section('headers')
